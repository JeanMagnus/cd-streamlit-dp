...
st.write("""
As correlações mais significativas envolvem histórico familiar e acesso a cuidados.
Essas variáveis parecem influenciar diretamente a decisão de procurar tratamento.
""")
